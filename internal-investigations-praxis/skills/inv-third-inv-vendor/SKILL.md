...
description: "Nutze dies bei Inv 036 Third Party Agent, Inv 037 Vendor Kickback: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt."
---
...
Dieser Arbeitsbereich führt die Teilfragen zu **Inv 036 Third Party Agent, Inv 037 Vendor Kickback** in einem handhabbaren Prüfpfad zusammen. Beginne mit dem Modul, das die Akte wirklich trägt; kombiniere weitere Module nur, wenn Frist, Zuständigkeit, Beweislast oder Output dadurch konkret besser werden.
