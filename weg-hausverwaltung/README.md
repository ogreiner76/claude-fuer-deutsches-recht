...
| `weg-hausverwaltung-chronologie-und-belegmatrix` | Chronologie und Belegmatrix im Plugin Weg Hausverwaltung: prüft Tatbestand, Zuständigkeit, Frist und Beweislage entlang der Plugin-Norm-Anker und liefert priorisierten Output (Norm-Pinpoints, Risikoampel, nächster Schritt). |
...
| `weg-hausverwaltung-fristen-und-risikoampel` | Fristen- und Risikoampel im Plugin Weg Hausverwaltung: prüft Tatbestand, Zuständigkeit, Frist und Beweislage entlang der Plugin-Norm-Anker und liefert priorisierten Output (Norm-Pinpoints, Risikoampel, nächster Schritt). |
