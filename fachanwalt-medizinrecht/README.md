...
| `einstieg-routing` | Einstieg, Triage und Routing für Fachanwalt Medizinrecht: ordnet Rolle (Patient, Arzt/Krankenhaus, Krankenkasse), markiert Frist (Verjährung 3 Jahre § 195 BGB), wählt Norm (BGB §§ 630a ff. Behandlungsvertrag, AMG, MPDG, SGB V, BÄO, MBO-Ä... |
