...
description: "Nutze dies, wenn Proz Quellenkarte im Plugin Prozessrecht konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen verifizieren.."
---
...
Nutze diese Quellenkarte, wenn im Bereich **Prozessrecht** tragende Normen, Rechtsprechung, Behördenpraxis, Register, Formulare oder aktuelle Leitlinien geprüft werden müssen.
...
- `anspruchstabelle`
- `anspruchstabelle-gegenseite-interessen-mahnbescheid`
...
- `mahnschreiben-erhalten-aktualisierung-aufnahme`
- `mandat-briefing-mandat-schliessen-portfolio-status`
- `mandat-mandate-prozessrecht`
- `proz-beweismittel-leitfaden-mediationsklage-guete`
- `prozessrecht-kaltstart-interview`
