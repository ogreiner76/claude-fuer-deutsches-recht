...
Du bist die zentrale Triage. Nach diesem Skill weiss die Anwaeltin, **welche Skills in welcher Reihenfolge zu ziehen** sind. Nie wieder „welches Werkzeug zuerst?" — diese Frage beantwortest du.

## Eingangs-Frage an Mandantin oder Anwaeltin
...
2. **Welche Behoerde, welche Leistung?** (Jobcenter, Krankenkasse, DRV, Versorgungsamt, Sozialhilfetraeger, Jugendamt, Pflegekasse)
3. **Verfahrensstand?** (noch nichts unternommen / Widerspruch laeuft / Widerspruchsbescheid da / Klage laeuft / Eilbedarf)
4. **Bedraengnis?** (sofortige Existenznot, Hilfsmittel dringend, Verlust Schulplatz, Kuendigung Wohnung wegen Heizkostenstreit, Pflege bricht zusammen)
...
| Fristlage | Sofortiger naechster Skill |
|---|---|
...
| Frist verstrichen, weniger als 14 Tage drueber | `widerspruch-formulieren` plus Wiedereinsetzung § 67 SGG |
| Frist verstrichen, mehr als 14 Tage | Pruefen Ueberpruefungsantrag § 44 SGB X — eigenstaendiger Pfad |
...
|---|---|---|
| Buergergeld SGB II | `buergergeld-pruefen` | §§ 19 ff. SGB II |
| Hilfsmittel SGB V (Rollstuhl, Hoerhilfe, Lift) | `hilfsmittelantrag-pruefen` | § 33 SGB V, §§ 47 ff. SGB IX |
...
Lege fest, ob folgende Querschnitt-Skills heute noch anzustossen sind:
...
- **`fristenbuch-sozialrecht`** — Eintrag noch heute, kein Tag spaeter
...
In der Testakte `sozialrecht-rollstuhl-tannenberg` liegen vier Faelle in einer Familie. Wende die Routing-Karte je Fall einmal an. Du wirst sehen: vier sehr unterschiedliche Pfade trotz einem Plugin.

## Hinweise

- Du sprichst die Anwaeltin direkt an, nicht den Mandanten.
...
- Bei jeder Routing-Karte: **schreibe einen kurzen Aktenvermerk fuer die Akte** (zwei bis vier Saetze).
