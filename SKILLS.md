...
Automatisch generierte Gesamtuebersicht aller **18325 Skills** in **210 Plugins**.
...
Die Detailseiten liegen unter [`skills-index/`](skills-index/) -- eine eigene `.md`-Datei pro Plugin. So bleibt diese Hauptseite klein und laedt schnell, statt mit 18325 Tabellenzeilen den Browser-Renderer von GitHub zu ueberfordern.
...
| **forderungsmanagement-klagewerkstatt** | 84 | [Skills ansehen](skills-index/forderungsmanagement-klagewerkstatt.md) | [Download](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/forderungsmanagement-klagewerkstatt.zip) |
