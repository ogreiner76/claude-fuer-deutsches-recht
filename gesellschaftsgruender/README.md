...
| `gesellschaftsgruender-ag-kleine-ag` | Prüft AG-Gründung, Satzung, Vorstand, Aufsichtsrat, Kapital und Investorenfähigkeit: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-aufloesung-liquidation-start` | Prüft geordnete Beendigung einer jungen Gesellschaft: Beschluss, Liquidatoren, Sperrjahr, Register, Gläubiger: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-auslandsgesellschafter-kyc` | Prüft Gründung mit ausländischen Gesellschaftern: Dokumente, Apostille, Register, Sanktionen, UBO und Bank-KYC: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-bankkonto-kyc-beirat` | Erstellt Bankkonto-Unterlagenpaket für Gründung und Kapitalerhöhung: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-board-pack-erste-100-tage` | Erstellt Board-/Beiratsunterlagen für die ersten 100 Tage nach Gründung: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-cashburn` | Prüft Liquiditätsreichweite, Stammkapitalverlust, Zahlungsunfähigkeit und Überschuldungswarnungen: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-checkliste-vor-unterschrift` | Letztes Qualitygate vor Satzung, SHA, GF-Vertrag, Bankformular oder Notartermin: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-daten-und-ki-compliance-start` | Prüft Datenschutz, KI-VO, Datenquellen und Modellnutzung im Gründungsstadium: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-deadlock-und-mediation` | Entwirft Deadlock-Mechanismen, Eskalationsleitern und Mediationsklauseln: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-egbr-grundstueck` | Prüft eGbR bei Grundstückserwerb, Grundbuchfähigkeit, Register und Gesellschafterwechsel: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-familiengesellschaft` | Prüft Familien-GbR/GmbH/KG für Vermögen, Nachfolge, Minderjährige und Stimmrechte: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-finanzierungsrunde-seed` | Führt durch Seed-Runde: Term Sheet, Bewertung, Verwässerung, Cap Table, Satzung, SHA, Closing: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-founder-vesting` | Entwirft Founder-Vesting mit Cliff, Good/Bad Leaver und Rückübertragung: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-freiberufler-partg-gbr` | Prüft Freiberuflerstrukturen, PartG, PartG mbB, Berufshaftpflicht und Berufsrecht: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-gbr-zu-ohg-statuswechsel` | Prüft MoPeG-Statuswechsel von eGbR zu OHG/KG bei wachsendem Geschäftsbetrieb: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-genossenschaft-eg` | Prüft, ob eine eG statt GmbH/GbR sinnvoll ist: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-ggmbh-gemeinnuetzigkeit` | Prüft gGmbH-Gründung, Satzungszweck, Mittelbindung und Finanzamt-Abstimmung: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-gruenderrollen-konfliktcheck` | Klärt Rollen, Beiträge, Erwartungen, Streitpunkte und Exit-Szenarien vor Satzungsentwurf: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-holdingmodell` | Prüft Holding vor operativer Gesellschaft, Beteiligungen, Steuer-/Haftungs- und Governancefragen: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-investor-dd-vorbereiten` | Baut Datenraum für Investor-DD: Corporate, Finance, IP, HR, Datenschutz, Verträge: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-ip-einbringung` | Prüft, ob Software, Marken, Designs, Domains und Know-how sauber in die Gesellschaft gelangen: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-lizenz-und-vertriebsstart` | Erstellt rechtliche Startliste für erste Kundenverträge, AGB, Datenschutz, IP und Gewährleistung: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-lohn-payroll-start` | Prüft erste Beschäftigte, Minijob, SV-Meldung, Lohnkonto, BG und Arbeitsverträge: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-mandantenbrief-naechste-schritte` | Schreibt verständlichen Gründerbrief mit Entscheidungen, Risiken, To-dos, Kosten und Zeitplan: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-mietvertrag-buero-labor` | Prüft Mietvertrag vor Gründung/Eintragung, Vor-GmbH-Haftung und Genehmigungen: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-minderjaehrige-gesellschafter` | Prüft Minderjährige in Gesellschaften: Vertretung, Familiengericht, Haftung und Genehmigungen: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-mitarbeiter-gf-arbeitsvertrag` | Prüft Gründeranstellung, Geschäftsführervertrag, Sozialversicherung, IP und Wettbewerbsverbote: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-mitarbeiterbeteiligung-esop-vsop` | Prüft Mitarbeiterbeteiligung, virtuelle Anteile, Vesting, Leaver und Steuer-/Arbeitsrechtsschnittstellen: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-musterprotokoll-vs` | Entscheidet, ob Musterprotokoll reicht oder individuelle Satzung nötig ist: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-notarbriefing-onepager` | Erstellt ein Notarbriefing mit Firma, Sitz, Gegenstand, Kapital, Gesellschaftern, GF, Besonderheiten: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-one-page-roadmap` | Erstellt eine einseitige Roadmap von Idee bis Eintragung und operativem Start: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-open-source-plain` | Prüft Open-Source-Risiken vor Gründung, Finanzierung und Due Diligence: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-plain-language-modus` | Übersetzt Gründungsrecht in einfache Sprache, ohne rechtliche Präzision zu verlieren: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-produkt-und-produkthaftung-start` | Prüft CE, Produktsicherheit, Bedienungsanleitung, Haftung und Versicherung vor Markteintritt: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-registerbeanstandung-beantworten` | Hilft bei Zwischenverfügung/Registerbeanstandung nach Gründung oder Änderung: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-reguliertes-geschaeftsmodell` | Erkennt Erlaubnispflichten vor Gründung: Finanzen, Versicherung, Medizin, Makler, Bewachung, Handwerk, Güterverkehr, Lebensmittel: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-sacheinlage-und-verdeckte-sacheinlage` | Prüft Sacheinlagen, Werthaltigkeit, Sachgründungsbericht und verdeckte Sacheinlage: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-steuerliche-erfassung` | Führt durch Fragebogen steuerliche Erfassung, USt, Dauerfristverlängerung und Lohnsteuer: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-transparenzregister` | Prüft Aktualisierung wirtschaftlich Berechtigter nach Anteilserwerb, Treuhand, Pooling oder Kontrolle: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-treuhand-und-nominee` | Prüft Treuhand, wirtschaftlich Berechtigte, Stimmrechte, Steuer- und GwG-Risiken: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-umsatzsteuer-start` | Prüft USt-Startfragen, Kleinunternehmer, Reverse Charge, innergemeinschaftliche Lieferungen und Rechnungen: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `gesellschaftsgruender-versicherungen-start` | Prüft D&O, Betriebshaftpflicht, Cyber, Produkthaftpflicht, Berufshaftpflicht und Key Person: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-vinkulierung-und-transfer` | Prüft Vinkulierung, Zustimmung, Vorerwerbsrechte, Drag/Tag und Joinder: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gesellschaftsgruender-wandeldarlehen` | Prüft Wandeldarlehen, Discount, Cap, Wandlung, Rang, Prospekt-/Bankaufsichtsrisiken: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `gmbh-gesellschaftsgruender` | Fristen- und Risikoampel: macht eine Sofortampel für Frist, Zuständigkeit, Haftung, Eilbedarf und fehlende Unterlagen: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `leaver-klauseln-mietvertrag-buero-mitarbeiter` | Prüft Good/Bad-Leaver-Klauseln, Abfindung, Einziehung und Durchsetzbarkeit: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `sanktionen-investorcheck-gewerbeanmeldung` | Prüft Investoren und Gesellschafter auf Sanktions-, Geldwäsche- und Außenwirtschaftsrisiken: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
| `se-crossborder-sha-satzung-stammkapital` | Prüft SE und grenzüberschreitende Gründungs-/Holdingfragen auf Einstiegsebene: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
