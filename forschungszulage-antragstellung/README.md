...
| Skill | Beschreibung |
| --- | --- |
| `abgrenzung-adaptiver-antrag` | Abgrenzung Adaptiver Antrag im Forschungszulage-Antragstellung: prüft konkret Abgrenzung, Adaptiver, Antrag. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `antragstellung-auszahlung-beihilfen` | Auszahlung Beihilfen im Forschungszulage-Antragstellung: prüft konkret Antragstellung, Auszahlung, Beihilfen. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `bemessungsgrundlage-interessen-bsfz` | Bemessungsgrundlage Interessen Bsfz im Forschungszulage-Antragstellung: prüft konkret Bemessungsgrundlage, Bsfz, Definition. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `forsch-stundenaufzeichnung-fz-ablehnung` | Forsch Stundenaufzeichnung FZ Ablehnung im Forschungszulage-Antragstellung: prüft konkret Leitfaden Stundenaufzeichnung FZulG, Ablehnung oder Nachforderung bei Forschungszulage, Bemessungsgrundlage Forschungszulage ab 2026 belastbar. Lie... |
...
| `forschungszulage-antragstellung-fz-bescheidung-rechtsmittel-bsfz` | FZ Bescheidung Rechtsmittel Bsfz im Forschungszulage-Antragstellung: prüft konkret Bescheidung Forschungszulage, BSFZ-Antrag und FuE-Projektbeschreibung praxistauglich, Dokumentationspaket Forschungszulage prüfungsfest aufbauen. Liefert... |
| `forschungszulage-antragstellung-fz-betriebspruefung-strategie` | FZ Betriebspruefung Strategie im Forschungszulage-Antragstellung: prüft konkret Strategie bei Betriebspruefung mit Schwerpunkt, Forschungszulage beim Finanzamt beantragen, festsetzen und auszahlen lassen, Historie und Rechtsgrundlagen de... |
| `forschungszulage-antragstellung-fz-fue-abgrenzung-definition` | FZ FUE Abgrenzung Definition im Forschungszulage-Antragstellung: prüft konkret FuE-Definition Grenzfaelle nach Frascati-Manual und FZulG, FuE-Definition für die Forschungszulage praxisnah prüfen, Spezialfall Konzern und Organschaft. Lief... |
| `forschungszulage-antragstellung-fz-koordinierung-zwei` | FZ Koordinierung Zwei im Forschungszulage-Antragstellung: prüft konkret Koordinierung Forschungszulage mit anderen Foerderwegen, Kumulierung Forschungszulage mit anderen Förderungen und, Foerderfaehige Personalkosten der Forschungszulage... |
| `forschungszulage-antragstellung-fz-plaedoyer-begruendung-roadmap` | FZ Plaedoyer Begruendung Roadmap im Forschungszulage-Antragstellung: prüft konkret Plädoyer, Begründung und Verteidigung der Forschungszulage, Mehrjahresstrategie Forschungszulage, Start-up- und Personengesellschafts-Konstellation. Liefe... |
...
| `forschungszulage-antragstellung-start-chronologie-fristen` | Start Chronologie Fristen im Forschungszulage-Antragstellung: prüft konkret Adaptiver Einstieg, Mandatsklärung und Routing im Forschungszulage-Plugin, Chronologie und Belegmatrix im Plugin, Fristen- und Risikoampel im Plugin. Liefert pri... |
...
| `forschungszulage-antragstellung-workflow-mandantenkommunikation` | Workflow Mandantenkommunikation im Forschungszulage-Antragstellung: prüft konkret Mandantenkommunikation im Plugin, Red-Team Qualitygate im Plugin, FZulG. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `forschungszulage-insolvenzlage-red` | Insolvenzlage RED im Forschungszulage-Antragstellung: prüft konkret Forschungszulage, Insolvenzlage, Portaltexte. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `fz-insolvenz-forsch-konzernverbund` | FZ Insolvenz Forsch Konzernverbund im Forschungszulage-Antragstellung: prüft konkret Forschungszulage in Verlust-, Krisen- und Insolvenzlagen als Liquiditätshebel nu, Spezialfall Konzernverbundforschung und verbundene, Bauleiter Projektb... |
...
| `mandantenentscheidung-einspruch-sonderfall` | Mandantenentscheidung Einspruch Sonderfall im Forschungszulage-Antragstellung: prüft konkret Dokumentation, Einspruch, Foerdercheck. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `mehrjahresroadmap-fristennotiz-fz` | Mehrjahresroadmap Fristennotiz FZ im Forschungszulage-Antragstellung: prüft konkret Mehrjahresroadmap, Auftragsforschung im Sinne § 3 Abs, Spezialfall BSFZ-Pruefung und Nachfragen. Liefert priorisierten Output mit Norm-Pinpoints, Risikoa... |
...
| `verlust-zeichenbudgets` | Verlust Zeichenbudgets im Forschungszulage-Antragstellung: prüft konkret Verlust, Zeichenbudgets. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
