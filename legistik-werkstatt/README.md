...
| Skill | Beschreibung |
| --- | --- |
| `aenderungs` | Nutze dies, wenn Aenderungs: Formular, Portal und Einreichungslogik im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Aenderungs: Formular, Portal und Einreichungslogik prüfen.; Erstelle eine Arbeitsfassung zu... |
...
| `anschluss-routing` | Nutze dies, wenn Anschluss-Routing im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Ich habe ein neues Thema im Bereich Legistik Werkstatt.; Welche Unterlagen brauchen Sie?; Welcher Spezialskill passt?. |
| `baut-quellenkarte` | Nutze dies, wenn Baut Quellenkarte im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen verifizieren.. |
...
| `bundestag` | Nutze dies, wenn Bundestag: Fristen, Form, Zuständigkeit und Rechtsweg im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Bundestag: Fristen, Form, Zuständigkeit und Rechtsweg prüfen.; Erstelle eine Arbeitsfassu... |
| `chronologie-und-belegmatrix` | Nutze dies, wenn Chronologie und Belegmatrix im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Chronologie und Belegmatrix prüfen.; Erstelle eine Arbeitsfassung zu Chronologie und Belegmatrix.; Welche Normen un... |
| `dokumente-intake` | Nutze dies, wenn Dokumentenintake im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dokumente sortieren.. |
...
| `einstieg-routing` | Nutze dies, wenn Einstieg und Routing im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Ich habe ein neues Thema im Bereich Legistik Werkstatt.; Welche Unterlagen brauchen Sie?; Welcher Spezialskill passt?. |
| `entschliessungsantraege-fehlerkatalog` | Nutze dies, wenn Entschliessungsantraege Fehlerkatalog im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Was kann hier schiefgehen?; Bitte red-team prüfen.; Welche Frist oder Beweislast übersehe ich?. |
...
| `folgenabschaetzung-erfuellungsaufwand-02` | Nutze dies, wenn Folgenabschaetzung Erfuellungsaufwand, Folgenabschaetzung Nachhaltigkeit, Formulierungshilfe Bauen, Gesetzgebungskompetenz Prüfen im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Folgenabschae... |
...
| `fraktionen` | Nutze dies, wenn Fraktionen: Dokumentenmatrix, Lückenliste und Nachforderung im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dokumente sortieren.. |
| `fristen-und-risikoampel` | Nutze dies, wenn Fristen- und Risikoampel im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Fristen- und Risikoampel prüfen.; Erstelle eine Arbeitsfassung zu Fristen- und Risikoampel.; Welche Normen und Nachwei... |
...
| `goldplating-vermeiden-inkrafttreten` | Nutze dies, wenn Goldplating Vermeiden, Inkrafttreten Uebergangsrecht, Legistik Auftragsaufnahme, Legw Aa Ausfuhrkontrolle Und Aussenwirtschaftsdimension im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Goldpl... |
...
| `kabinettsentwuerfe` | Nutze dies, wenn Kabinettsentwuerfe: Compliance-Dokumentation und Aktenvermerk im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dokumente sortieren.. |
| `laender` | Nutze dies, wenn Laender: Behörden-, Gerichts- oder Registerweg im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Laender: Behörden-, Gerichts- oder Registerweg prüfen.; Erstelle eine Arbeitsfassung zu Laender:... |
| `laender-landtage-legistik-ministerien` | Nutze dies, wenn Spezial Länder Behörden Gericht Und Registerweg, Spezial Landtage Schriftsatz Brief Und Memo Bausteine, Spezial Legistik Erstpruefung Und Mandatsziel, Spezial Ministerien Tatbestand Beweis Und Belege, Spezial Mitte Inter... |
| `landtage` | Nutze dies, wenn Landtage: Schriftsatz-, Brief- und Memo-Bausteine im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Landtage: Schriftsatz-, Brief- und Memo-Bausteine prüfen.; Erstelle eine Arbeitsfassung zu La... |
| `legistik` | Nutze dies, wenn Legistik: Erstprüfung, Rollenklärung und Mandatsziel im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte
Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslös... |
...
| `legw-ressortaufgaben-bmv-bmvg-bmwe-bmwsb-bmz` | Nutze dies, wenn Legw Ressortaufgaben Bmv, Legw Ressortaufgaben Bmvg, Legw Ressortaufgaben Bmwe, Legw Ressortaufgaben Bmwsb, Legw Ressortaufgaben Bmz und 3 weitere Themen im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslö... |
...
| `legw-rmap-evaluierung-export` | Nutze dies, wenn Legw Rmap Evaluierung Und Aenderung, Legw Rmap Export Und Systemintegration, Legw Rmap Grundlagen, Legw Rmap Norm Zu Rulemap, Legw Rmap Tatbestand Und Rechtsfolge und 3 weitere Themen im Plugin Legistik Werkstatt konkret... |
...
| `ministerien` | Nutze dies, wenn Ministerien: Tatbestandsmerkmale, Beweisfragen und Beleglage im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Ministerien: Tatbestandsmerkmale, Beweisfragen und Beleglage prüfen.; Erstelle ein... |
| `mitte` | Nutze dies, wenn Mitte: Internationaler Bezug und Schnittstellen im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Mitte: Internationaler Bezug und Schnittstellen prüfen.; Erstelle eine Arbeitsfassung zu Mitte:... |
...
| `normenkartierung-normenkontrollrat-kmu` | Nutze dies, wenn Normenkartierung, Normenkontrollrat Kmu Check, Normhierarchie Routing, Satzungskompetenz Prüfen im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Ich habe ein neues Thema im Bereich Legistik Werkstat... |
...
| `normgeber` | Nutze dies, wenn Normgeber: Verhandlung, Vergleich und Eskalation im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Normgeber: Verhandlung, Vergleich und Eskalation prüfen.; Erstelle eine Arbeitsfassung zu Norm... |
...
| `opposition` | Nutze dies, wenn Opposition: Risikoampel, Gegenargumente und Verteidigungslinien im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Opposition: Risikoampel, Gegenargumente und Verteidigungslinien prüfen.; Erstel... |
| `output-waehlen` | Nutze dies, wenn Output wählen im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Output wählen prüfen.; Erstelle eine Arbeitsfassung zu Output wählen.; Welche Normen und Nachweise brauche ich?. |
| `quellen-livecheck` | Nutze dies, wenn Rechtsquellen-Livecheck im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen verifizieren.. |
| `referenten` | Nutze dies, wenn Referenten: Zahlen, Schwellenwerte und Berechnung im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Referenten: Zahlen, Schwellenwerte und Berechnung prüfen.; Erstelle eine Arbeitsfassung zu Re... |
| `referenten-vorlagen-interessen-synopse` | Nutze dies, wenn Spezial Referenten Zahlen Schwellen Und Berechnung, Spezial Vorlagen Mehrparteien Konflikt Und Interessen, Synopse Erstellen, Terminologie Konsistenz im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser:... |
...
| `schulung-legistik-aenderungs-fraktionen` | Nutze dies, wenn Schulung Legistik, Spezial Aenderungs Formular Portal Und Einreichung, Spezial Fraktionen Dokumentenmatrix Und Lueckenliste, Spezial Kabinettsentwuerfe Compliance Dokumentation Und Akte im Plugin Legistik Werkstatt konkr... |
...
| `unterlagen-luecken` | Nutze dies, wenn Unterlagen und Lücken im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dokumente sortieren.. |
...
| `verfassungsmaessigkeit-quercheck-02` | Nutze dies, wenn Verfassungsmaessigkeit Quercheck, Verordnungsermaechtigung Art80, Xml Paralleldarstellung, Zirkelschluss Prüfen im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Verfassungsmaessigkeit Querchec... |
...
| `vorlagen-interessen` | Nutze dies, wenn Vorlagen: Mehrparteienkonflikt und Interessenmatrix im Plugin Legistik Werkstatt konkret bearbeitet werden soll. Auslöser: Bitte Vorlagen: Mehrparteienkonflikt und Interessenmatrix prüfen.; Erstelle eine Arbeitsfassung z... |
