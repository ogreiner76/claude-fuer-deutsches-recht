...
| Skill | Beschreibung |
| --- | --- |
| `automation-monitoring-billing-narratives` | Automation Monitoring Billing Narratives im Corporate-Kanzlei-Praxis: prüft konkret Automationen und Monitoring, Corporate Billing Narratives. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `board-paper-closing-bible` | Board Paper Closing Bible im Corporate-Kanzlei-Praxis: prüft konkret Board Paper und Business Judgment Rule (§ 93 AktG, § 43 GmbHG) erstellen, Closing Bible und Deal-Archiv nach M&A-Closing erstellen. Liefert priorisierten Output mit Nor... |
| `conflict-gwg-datenqualitaet-xai` | Conflict GWG Datenqualitaet XAI im Corporate-Kanzlei-Praxis: prüft konkret Konflikt-, GwG- und Sanktionscheck, Qualitaetskontrolle und Quellenvalidierung im. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `corporate-beirat-gmbh` | Beirat Gmbh im Corporate-Kanzlei-Praxis: prüft konkret Corporate, Prüft und entwirft GmbH-Beiratsregeln für mittelständische. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `corporate-kanzlei-lma-facility` | LMA Facility im Corporate-Kanzlei-Praxis: prüft konkret Deal-Kommandocenter Corporate/M&A, Prüft hochgeladene LMA-basierte Kreditverträge aus. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `datenraum-aufbau-gap` | Datenraum Aufbau GAP im Corporate-Kanzlei-Praxis: prüft konkret Virtuellen Datenraum strukturieren und befuellen für, Public M&A, Gap-Analyse des Datenraums und Clean-Room-Protokoll für. Liefert priorisierten Output mit Norm-Pinpoints, R... |
| `deal-intake-team` | Deal Intake Team im Corporate-Kanzlei-Praxis: prüft konkret Neues Transaktionsmandat strukturiert aufnehmen aus E-Mail, Teaser, NDA, Term Sh. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `disclosure-schedules-distressed-ma` | Disclosure Schedules Distressed MA im Corporate-Kanzlei-Praxis: prüft konkret Disclosure Schedules zum SPA erstellen und prüfen, Prüffeld für corporate kanzlei distressed ma. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel u... |
| `due-diligence-commercial-und-legal` | DUE Diligence Commercial und Legal im Corporate-Kanzlei-Praxis: prüft konkret Commercial Contracts Due Diligence, Legal Due Diligence für M&A-Transaktionen. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `due-diligence-expert-calls` | DUE Diligence Expert Calls im Corporate-Kanzlei-Praxis: prüft konkret DD-Reporting, Expert Calls und Transkript-Auswertung in M&A-Due-Diligence. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `fair-disclosure-kg-personengesellschaften` | Fair Disclosure KG Personengesellschaften im Corporate-Kanzlei-Praxis: prüft konkret Fair Disclosure und Knowledge Management, KG und Personengesellschaften im Corporate/M&A-Kontext. Liefert priorisierten Output mit Norm-Pinpoints, Risik... |
| `freundlicher-copilot-gesellschaftsrecht` | Freundlicher Copilot Gesellschaftsrecht im Corporate-Kanzlei-Praxis: prüft konkret Freundlicher Corporate-Copilot, Gesellschaftsrechtliche Registeranmeldungen und. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem... |
| `handelsregisterabruf-ki-governance` | Handelsregisterabruf KI Governance im Corporate-Kanzlei-Praxis: prüft konkret Handelsregister-Daten abrufen und analysieren, KI-Governance und Berufsrecht. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `look-feel-matter-file` | Look Feel Matter File im Corporate-Kanzlei-Praxis: prüft konkret Corporate-Cowork-Design, Transaktionsakte strukturieren und verwalten für. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `npl-distressed-outside-target` | NPL Distressed Outside Target im Corporate-Kanzlei-Praxis: prüft konkret Prüft Erwerb/Verkauf notleidender Darlehen im, Outside-In-Zielunternehmen-Screening aus öffentlichen. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel u... |
| `post-closing-umwandlungssteuerrecht` | Post Closing Umwandlungssteuerrecht im Corporate-Kanzlei-Praxis: prüft konkret Post-Closing-Integration (PMI) rechtlich begleiten, Umwandlungssteuerrecht. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `public-ma-qa-information` | Public MA QA Information im Corporate-Kanzlei-Praxis: prüft konkret Public M&A und Kapitalmarkt, Q&A- und Information-Request-Management in M&A-Transaktionen. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schr... |
| `rechtsprechungsrecherche-spa-apa` | Rechtsprechungsrecherche SPA APA im Corporate-Kanzlei-Praxis: prüft konkret Corporate-Rechtsprechungsrecherche, SPA (Share Purchase Agreement) oder APA (Asset Purchase. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und näc... |
| `regulatory-fdi-restructuring-starug` | Regulatory FDI Restructuring Starug im Corporate-Kanzlei-Praxis: prüft konkret Anmeldepflichten Fusionskontrolle und FDI prüfen, StaRUG-Restrukturierungsplan und Insolvenzplan für. Liefert priorisierten Output mit Norm-Pinpoints, Risikoa... |
| `schuldschein-darlehen-signing-closing` | Schuldschein Darlehen Signing Closing im Corporate-Kanzlei-Praxis: prüft konkret Prüft Schuldscheindarlehen in Corporate/M&A, Refinanzierung und Secondary Trades, Signing und Closing Conditions verwalten. Liefert priorisierten Output mit... |
| `simulation-bidder-steps-plan` | Simulation Bidder Steps Plan im Corporate-Kanzlei-Praxis: prüft konkret Auktionsprozess und Bieter-Perspektive in M&A-Transaktionen, Steps Plan und Transaktions-PMO für M&A-Mandate erstellen. Liefert priorisierten Output mit Norm-Pinpoin... |
| `tabellenreview-3d-teaser-processdocs` | Tabellenreview 3D Teaser Processdocs im Corporate-Kanzlei-Praxis: prüft konkret Strukturierte Datentabellen aus M&A-Datenräumen prüfen und, Teaser, Information Memorandum und Prozessdokumente für. Liefert priorisierten Output mit Norm-Pi... |
| `transaktionsstruktur-translations` | Transaktionsstruktur Translations im Corporate-Kanzlei-Praxis: prüft konkret Transaktionsstruktur, Mehrsprachige Transaktionsdokumente in DE/EN erstellen und. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schr... |
| `umwandlungsrecht-wi-insurance` | Umwandlungsrecht WI Insurance im Corporate-Kanzlei-Praxis: prüft konkret Umwandlungsrecht, W&I-Versicherung (Warranty & Indemnity Insurance). Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `vertragsmarkup-key-agio` | Vertragsmarkup KEY Agio im Corporate-Kanzlei-Praxis: prüft konkret Juristischen Markup für M&A-Vertraege und Key-Issues-Memo, Strukturierung von Kapitalerhöhungen mit Agio bei. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel... |
