...
| `anlage-red-anlagen-anlagenkonvolut-sonderfall` | Anlage RED Anlagen Anlagenkonvolut Sonderfall im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Anlage, Anlagen, Anlagenkonvolut, Entscheidet Stempelbild. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `anlagen-an-assistenz-uebersetzungspflicht` | AN Assistenz Uebersetzungspflicht im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Erzeugt klare Arbeitsanweisungen für Kanzleiteam, Assistenz, Legal Tech oder ext, Fremdsprachige Anlagen. Liefert priorisierten Output mit Norm-Pinpoint... |
...
| `anlagen-berufung-revision-eilantrag-eu-bilder` | Berufung Revision Eilantrag EU Bilder im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Anlagen in Berufung und Revision, Anlagen fuer einstweilige Verfuegung und Arrest, Bilder und Screenshots als Anlagen, Erkennt doppelte Dateien. Lie... |
...
| `anlagen-check-zustellung-redaktion-dsgvo` | Check Zustellung Redaktion DSGVO im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Quality-Check fuer Anlagenpaket vor Zustellung, Prüft Anlagen vor Einreichung auf personenbezogene Daten, Geschäftsgeheimnisse, Anlagen schwaerzen und an... |
...
| `anlagen-elektronische-dokumente-format` | Elektronische Dokumente Format im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Spezialfall elektronische Dokumente als Anlage, Format und Dateinamen fuer Anlagen, Anlagen fuer beA-Versand vorbereiten, Spezialfür Eilverfahren. Liefert... |
...
| `anlagen-schriftsaetze-start-belegmatrix-fristen` | Schriftsaetze Start Belegmatrix Fristen im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Einstieg, Schnelltriage und Fallrouting im Anlagen Zu, Chronologie und Belegmatrix im Plugin, Fristen- und Risikoampel im Plugin anlagen-zu-schrif... |
...
| `anlagenband-strukturieren-anlagenbezug` | Anlagenband Strukturieren Anlagenbezug im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Anlagenband strukturieren, Wie Anlagen im Schriftsatz richtig eingefuehrt werden, Anlagenkonvolut aus Mandanten-ZIP konsolidieren, Entwirft eine ro... |
...
| `anlagenverzeichnis-kanzlei-grundaufbau-bea` | Anlagenverzeichnis Kanzlei Grundaufbau BEA im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Erstellt getrennte Anlagenverzeichnisse, Anlagenverzeichnis nach deutscher Anwaltsuebung aufbauen, Plant elektronische Anlagenpakete für beA/ER... |
| `baut-beweislast-benennt-bereits-excel` | Baut Beweislast Benennt Bereits Excel im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Prüft, ob die Anlage eine konkrete Darlegung trägt oder nur einen, Benennt, Bereits. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel un... |
...
| `beweisangebot-anlage-emails-chats-excel` | Beweisangebot Anlage Emails Chats Excel im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Zeugenbeweis korrekt ueber Anlagen unterstuetzen, Macht aus EML/MSG, Chatverläufen und Screenshots gerichtstaugliche Anlagen mit, Bereitet XLSX/CS... |
...
| `frist-eilversand-schiedsverfahren-anlagenband` | Frist Eilversand Schiedsverfahren Anlagenband im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Red-Team Qualitygate im Plugin anlagen-zu-schriftsaetzen, Minimalpfad bei drohender Frist, Plant Anlagenbände im Schiedsverfahren, Gerichtli... |
...
| `haftpflicht-versicherer-konvention-k` | Haftpflicht Versicherer Konvention K im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Anlagen-Pflicht gegenueber Haftpflichtversicherer, Hausratver, Konvention erklaert und korrekt eingesetzt, Anlagen-Konvention mandantenfreundlich. Li... |
...
| `k1-anlagenpaket-k1-sortierwerkstatt` | K1 Anlagenpaket K1 Sortierwerkstatt im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Aus einem Mandantenordner mit beliebigen Dateinamen die, K1-Leitanlage sortieren, Hilft bei Tausenden gleichartiger Dokumente, Entwirft Nummernkreise... |
...
| `konform-interessen-konvertiert-oben` | Konform Interessen Konvertiert Oben im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Konform, Prüft PDF-Konvertierung, Dateigrößen, Seitenzahlen. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `nachreichung-berichtigung-ocr-scan-original` | Nachreichung Berichtigung OCR Scan Original im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Plant die Reparatur eines Anlagenpakets nach gerichtlichem, Rüge der Geg, Prüft gescannte Anlagen auf Lesbarkeit, OCR-Durchsuchbarkeit. Liefer... |
...
| `pruefmodus-fristennotiz-datenraum-sharepoint` | Pruefmodus Fristennotiz Datenraum Sharepoint im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Validiert ein vorhandenes Anlagenpaket und gibt eine kurze, Überführt Datenraum-/SharePoint-/DMS-Exporte in Anlagenlogik, Anlagen aus IT-Syst... |
...
| `sortiert-stempelt-word` | Sortiert Stempelt Word im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Schriftsatz, Sortiert, Stempelt, Bereitet Word-. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `zuordnung-zeitleiste-belegkette` | Zuordnung Zeitleiste Belegkette im Plugin Anlagen Zu Schriftsaetzen: prüft konkret Zuordnung, Baut aus Anlagen eine Chronologie und zeigt zu jedem, welcher Beleg trä. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächs... |
