...
| `leichte-sprache-zielgruppe-zahlen-schwellen-berechnung` | Zielgruppe Zahlen Schwellen Berechnung im Einfache und leichte Sprache im Recht: Dieser Skill arbeitet Zielgruppe Zahlen Schwellen Berechnung als zusammenhängenden Arbeitsgang im Plugin Einfache Leichte Sprache Jura ab — nach Aktenlage,... |
