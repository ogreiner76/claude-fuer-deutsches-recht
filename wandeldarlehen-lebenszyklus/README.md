...
| `bilingual-einsprachig` | Bilingual Schriftsatz Brief Und Memo Bausteine, Einsprachig Verhandlung Vergleich Und Eskalation: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `cap-table-darlehenshoehe-konditionen` | Cap Table Update Pre Post, Darlehenshoehe Konditionen: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `dokumenten-upload-formfehler-heilungs` | Dokumenten Upload Extraktion, Formfehler Heilungs Timeline: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `einsprachige-vertragsfassung` | Einsprachige Vertragsfassung De, Vertragserstellung Behörden Gericht Und Registerweg: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `gesellschafterbeschluss-kapitalerhoehung` | Gesellschafterbeschluss Kapitalerhoehung, Gesellschafterbeschluss Vorbereiten: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `gesellschafterliste-aktualisieren` | Gesellschafterliste Aktualisieren, Gesellschafterversammlung Einberufen: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `gmbh-vollstaendigen` | Gmbh Risikoampel Und Gegenargumente, Vollstaendigen Tatbestand Beweis Und Belege: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `handelsregisteranmeldung-kapitalerhoehung-kyc` | Handelsregisteranmeldung Kapitalerhoehung, Kyc Aml Geldwaesche: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `lebenszyklus-bilinguale-vertragserstellung` | Lebenszyklus Fristen Form Und Zustaendigkeit, Bilinguale Vertragserstellung: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `mandat-triage-mehrere-parallel` | Mandat Triage Wandeldarlehen, Mehrere Wandeldarlehen Parallel: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `notar-paket-parteien-erfassen` | Notar Paket Uebermittlung, Parteien Erfassen: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `post-eintragung-rangruecktritt-formulieren` | Post Eintragung Checkliste, Rangruecktritt Formulieren: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `sacheinlagebericht-werthaltigkeit-begleitet` | Sacheinlagebericht Werthaltigkeit, Begleitet Erstpruefung Und Mandatsziel: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `unterzeichnung-elektronisch-wandelereignis` | Unterzeichnung Elektronisch Docusign, Wandelereignis Eingang: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `vertraulichkeit-sprachklausel` | Vertraulichkeit Und Sprachklausel, Beurkundungserfordernis Prüfung: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `wandeldarlehen-lebenszyklus-chronologie-fristen` | Chronologie Und Belegmatrix, Fristen Und Risikoampel: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `wandeldarlehens-wandelereignisse` | Wandeldarlehens Dokumentenmatrix Und Lueckenliste, Wandelereignisse Zahlen Schwellen Und Berechnung: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `wandelereignis-trigger-wandlung-kommunikation` | Wandelereignis Trigger Dispatcher, Wandlung Kommunikation Paketverteilung: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `wandlungsausloeser-cap-textform-vs` | Wandlungsausloeser Cap Und Discount, Textform Vs Schriftform Vs Notariell: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `wandlungsausschluss-wandlungsmechanik` | Wandlungsausschluss Prüfung, Wandlungsmechanik Konzipieren: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `wandlungspreis-wandlungspruefung-trigger` | Wandlungspreis Berechnung, Wandlungspruefung Trigger Liquidation: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `wandlungspruefung-trigger` | Wandlungspruefung Trigger Maturity, Wandlungspruefung Trigger Qualified Financing: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
