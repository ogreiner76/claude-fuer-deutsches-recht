...
description: "Space Traffic Management (STM) – Kollisionswarnungen, Ausweichmanöver, Haftungsverteilung, EU SST: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output."
---
