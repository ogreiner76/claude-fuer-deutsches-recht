# Ergänzende Korrespondenz und Vollvermerke zur Bonus-Untersuchung

## Vollständige Gesprächsnotiz

Am 04.06.2026 schilderte Nora Vellbruck, General Counsel der Rheinlicht Analytics GmbH die Angelegenheit in einem längeren Telefonat. Gegenstand ist Verdacht auf manipulierte Vertriebsboni, verdeckte Rückvergütungen eines Resellers und die Frage, ob eine interne Untersuchung durch zu breite Datensicherung unbeabsichtigt Material für ein Ermittlungsverfahren erzeugt. Die Darstellung war nicht linear: Zunächst standen praktische Fristen und die Sorge vor Eskalation im Vordergrund, danach erst die rechtliche Einordnung. Für die weitere Bearbeitung ist deshalb wichtig, die Akte nicht nur nach Rechtsgebieten, sondern nach Entscheidungsdruck zu ordnen: Was muss sofort gesichert werden, was darf noch offen bleiben, und welche Erklärung kann später als Einlassung, Geständnis, Anerkenntnis oder zumindest als ungünstige Tatsachenbehauptung gelesen werden.

Im Datenraum liegen Provisionsabrechnungen Januar 2024 bis April 2026, Chat-Auszüge aus dem CRM, drei Reisekostenabrechnungen und eine Excel-Datei mit nachträglich geänderten Bonusfaktoren. Der CFO möchte “einmal alles sichern”, der Betriebsrat verlangt dagegen eine konkrete Zweckbeschreibung und droht mit einer einstweiligen Verfügung gegen die Auswertung privater Chatanteile. Nach Durchsicht der bisherigen Unterlagen fällt auf, dass mehrere Beteiligte dieselben Worte unterschiedlich verwenden. “Freigabe”, “Kenntnis”, “Sicherung”, “Rüge” und “Abstimmung” tauchen in E-Mails, Tabellen und Gesprächsnotizen auf, ohne dass klar ist, ob damit eine rechtliche Erklärung, eine interne Arbeitsanweisung oder nur eine vorläufige Arbeitshypothese gemeint ist. Für die weitere Bearbeitung genügt deshalb kein bloßer Ergebnisvermerk. Erforderlich ist ein nachvollziehbarer Ablauf mit Tonfall, Unsicherheiten und Belegstellen, damit spätere Schreiben, Gespräche und Anträge auf derselben Tatsachengrundlage stehen.

## E-Mail der General Counsel an die externe Kanzlei nach dem ersten Hinweisgebergespräch

```
Von:      nora.vellbruck@rheinlicht-analytics.test
An:       dr.hagen@kanzlei-eichenhain.test
Datum:    Do 04.06.2026, 08:47 Uhr
Betreff:  Legal Hold, Interviewreihenfolge und Staatsanwaltschaftsrisiko - Vertrieb Süd
```
...
Bitte sichern Sie nur die benannten Custodians, verhindern Sie automatische Löschläufe und dokumentieren Sie jede Sichtung so, dass Privilege, Datenschutz und arbeitsrechtliche Anhörung getrennt bleiben. Bitte geben Sie mir bis morgen 12:00 Uhr eine Fassung, die ich intern weiterleiten kann. Sie darf gern klar sein, aber sie soll nicht dramatisieren. Wir brauchen eine Sprache, die die Sache ernst nimmt und trotzdem handhabbar bleibt.

Viele Grüße

Nora Vellbruck, General Counsel der Rheinlicht Analytics GmbH
...
## Entwurf einer internen Anordnung an IT und Vertrieb
