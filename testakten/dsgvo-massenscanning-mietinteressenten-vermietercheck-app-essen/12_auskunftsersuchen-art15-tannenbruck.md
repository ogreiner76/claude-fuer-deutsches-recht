...
- Beruf: Soziologin (Inhaberin eines Lehrstuhls an der Universität Duisburg-Essen, Forschungsschwerpunkt: Algorithmische Diskriminierung im Wohnungsmarkt)
...
- Prozessbevollmaechtigte: RAin Prof. Dr. Hannelore Stürmer-Koch, Essen
...
Dies ist für VCS besonders heikel: Die Offenlegung der ProspectScore-Logik (welche Datenpunkte, welche Gewichtung) birgt das Risiko, dass Dr. Tannenbruck die Diskriminierungsmechanismen des Modells wissenschaftlich dokumentiert.

---

## 3. Möglichkeiten der Einschränkung nach Art. 15 DSGVO

### 3.1 Ausnahmen und Einschränkungen

Art. 15 DSGVO sieht keine unmittelbaren Ausnahmen vor, aber ErwGr. 63 DSGVO gibt Hinweise: Das Recht auf Kopie darf die Rechte und Freiheiten anderer Personen nicht beeinträchtigen.

**Mögliche Einschränkungsgründe für VCS:**
1. **Geschäftsgeheimnisse (§ 14 GeschGehG):** Die interne Logik des ProspectScore-Algorithmus kann als Geschäftsgeheimnis qualifizieren. Jedoch: Der konkrete Score und die Datenkategorien der betroffenen Person selbst müssen offenbart werden.
...
3. **Missbräuchliche Auskunft:** Bei nachgewiesener Schikane-Absicht könnte § 242 BGB greifen — hier aber unwahrscheinlich.

**Ergebnis:** VCS muss den Score (78/100 — ROT) und die zugrundeliegenden Datenkategorien offenlegen. Die interne Algorithmuslogik kann als Geschäftsgeheimnis eingeschränkt werden, jedoch nur mit expliziter Begründung.

---

## 4. Fristen und Versäumnis
...
- Verlängerungsmöglichkeit: Weitere 2 Monate bei Komplexität (Art. 12 Abs. 3 Satz 2 DSGVO) — **Benachrichtigung erforderlich bis 12. Januar 2026**
- Tatsächliche Reaktion VCS: Keine Antwort bis 14.01.2026 (Mandatsuebernahme SBD)
...
**Sofortige Auskunftserteilung** vor dem nächsten Verhandlungstermin LG Essen ist die einzig sinnvolle Massnahme, um:
- Die Klagedurchsetzung (Hauptantrag Auskunft) zu neutralisieren
- Als Kooperationssignal zu wirken
- Den Schadensersatzanspruch von 1.500 EUR zu minimieren (kein zusätzlicher Verzugsschaden)
