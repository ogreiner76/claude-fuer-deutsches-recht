# 13 Szenario-Vergleich — StaRUG-Plan mit und ohne Debt-Equity-Swap
...
### Variante A — Sanierungsertrag (mit DES)

| Position | Wert (EUR) |
|---|---|
| Verzicht | 22.000.000 |
| DES-Sanierungsertrag-Anteil (WP-Werthaltigkeit 5,2 Mio EUR) | 2.800.000 |
| **Sanierungsertrag konsolidiert** | **24.800.000** |
| - Verlustvortrag KSt | -6.000.000 |
| **Verbleibend KSt** | **18.800.000** (steuerfrei nach § 3a EStG) |

### Variante B — Sanierungsertrag (reiner Verzicht 30 Mio EUR)

| Position | Wert (EUR) |
|---|---|
| Verzicht | 30.000.000 |
| **Sanierungsertrag** | **30.000.000** |
| - Verlustvortrag KSt | -6.000.000 |
| **Verbleibend KSt** | **24.000.000** (steuerfrei nach § 3a EStG) |
...
- Banken erhalten 35 % Anteile (Beteiligungsbeteiligung).
- Verlustabschreibung 22 Mio EUR (statt 30 Mio EUR).
- Bei Plan-Erfolg: Banken partizipieren am Wertzuwachs der Pellbach Windenergie GmbH.
- Bei Plan-Misserfolg: Anteile sind wertlos.

Banken-Sicht: **bevorzugt**, weil Upside-Potenzial.

### Variante B (reiner Verzicht)

- Banken haben keine Anteile.
- Verlustabschreibung 30 Mio EUR.
- Bei Plan-Erfolg: Banken haben keine Beteiligung am Wertzuwachs.
...
## VI. Steuerliche Sanity-Pruefung — Variante A (Plan-Vorlage)

| Position | KSt-Ebene (EUR) | GewSt-Ebene (EUR) |
|---|---|---|
| Sanierungsertrag (Verzicht + DES) | 24.800.000 | 24.800.000 |
| - Verlustvortrag | -6.000.000 | -9.000.000 |
| Verbleibend | 18.800.000 | 15.800.000 |
| § 3a Abs. 1 / § 7b GewStG | -18.800.000 | -15.800.000 |
| **Steuer 2026 (mit § 3a)** | **0** | **0** |
| Steuer 2026 (ohne § 3a) | 2.820.000 KSt + 155.100 Soli | 2.488.500 GewSt = ges. 5.463.600 |

## VII. Steuerliche Sanity-Pruefung — Variante B (kontrastiv)

| Position | KSt-Ebene (EUR) | GewSt-Ebene (EUR) |
|---|---|---|
| Sanierungsertrag (reiner Verzicht) | 30.000.000 | 30.000.000 |
| - Verlustvortrag | -6.000.000 | -9.000.000 |
| Verbleibend | 24.000.000 | 21.000.000 |
| § 3a Abs. 1 / § 7b GewStG | -24.000.000 | -21.000.000 |
| **Steuer 2026 (mit § 3a)** | **0** | **0** |
| Steuer 2026 (ohne § 3a) | 3.600.000 KSt + 198.000 Soli | 3.307.500 GewSt = ges. 7.105.500 |
...
|---|---|---|---|---|---|
| Buchner & Voltz (final) | 5.200.000 | 2.800.000 | 24.800.000 | 18.800.000 | 5.463.600 |
| Vellenbach-Prognose (vorab) | 5.200.000 | 2.800.000 | 24.800.000 | 18.800.000 | 5.463.600 |
| Werner konservativ | 2.000.000 | 6.000.000 | 28.000.000 | 22.000.000 | 6.301.500 |
| Banken liberal | 7.500.000 | 500.000 | 22.500.000 | 16.500.000 | 4.722.750 |

In allen Werthaltigkeits-Varianten ist die Sanierung mit § 3a EStG steuerfrei. Ohne § 3a EStG variieren die Steuerlast 4,7 — 6,3 Mio EUR.
