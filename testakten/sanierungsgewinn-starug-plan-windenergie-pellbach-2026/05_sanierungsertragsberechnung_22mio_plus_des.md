# 05 Sanierungsertragsberechnung — 22 Mio EUR Forderungsverzicht + DES-Anteil
...
| Investitionsbank Brandenburg (ILB) | 4.400.000 |
| **Summe Forderungsverzicht** | **22.000.000** |

### B. Debt-Equity-Swap (DES) — Steuerstruktur

Beim DES wandelt sich die Forderung der Banken in Anteile am Eigenkapital der Schuldnerin um. Steuerlich ist dies eine **Sacheinlage**.

Die zentrale Frage: Welcher Teil ist Einlage (steuerneutral), welcher Sanierungsertrag (steuerpflichtig)?
...
Aufgliederung je Bank:

| Bank | DES-Nennwert (EUR) | Werthaltigkeit (EUR) | Einlage (EUR) | Sanierungsertrag-Anteil (EUR) |
|---|---|---|---|---|
| NordKurland Bank AG | 4.000.000 | 2.600.000 | 2.600.000 | 1.400.000 |
| Commerzbank AG | 2.400.000 | 1.560.000 | 1.560.000 | 840.000 |
| ILB | 1.600.000 | 1.040.000 | 1.040.000 | 560.000 |
| **Summe** | **8.000.000** | **5.200.000** | **5.200.000** | **2.800.000** |
...
## III. Konsolidierter Sanierungsertrag

| Position | EUR |
|---|---|
| A. Forderungsverzicht | 22.000.000 |
| B. DES-Sanierungsertrag-Anteil (Werthaltigkeit Gutachten 5,2 Mio EUR) | 2.800.000 |
| C. Stundung (steuerneutral) | 0 |
| **Sanierungsertrag i.S.v. § 3a EStG (konsolidiert)** | **24.800.000** |

## IV. Empfindlichkeitsanalyse Werthaltigkeit DES

Falls die Werthaltigkeit konservativer (2 Mio EUR) oder liberaler (7,5 Mio EUR) bewertet wird:

| Variante | DES-Werthaltigkeit (EUR) | DES-Sanierungsertrag (EUR) | Gesamt-Sanierungsertrag (EUR) | Verbleibend KSt (nach 6 Mio Verlust) | Verbleibend GewSt (nach 9 Mio Verlust) |
|---|---|---|---|---|---|
| Vellenbach (Plan-Annahme) | 5.200.000 | 2.800.000 | 24.800.000 | 18.800.000 | 15.800.000 |
| Werner konservativ | 2.000.000 | 6.000.000 | 28.000.000 | 22.000.000 | 19.000.000 |
| Banken liberal | 7.500.000 | 500.000 | 22.500.000 | 16.500.000 | 13.500.000 |
| Verzicht ohne DES (Hauptzahl Akte) | n/a | 0 | 22.000.000 | 16.000.000 | 13.000.000 |

In allen Varianten ist der Sanierungsertrag mit § 3a EStG-Befreiung steuerfrei. Ohne § 3a EStG-Befreiung beziffert sich die Steuerlast wie folgt:

| Variante | KSt (15 %) | Soli (5,5 %) | GewSt (Cottbus 450 % auf 3,5 %) | Gesamt-Steuerlast (EUR) |
|---|---|---|---|---|
| Vellenbach | 2.820.000 | 155.100 | 2.488.500 | 5.463.600 |
| Werner | 3.300.000 | 181.500 | 2.992.500 | 6.474.000 |
...
### A. Forderungsverzicht (Buchung)

```
Per: Bankforderungen NordKurland-Konsortium                                  22.000.000 EUR
An:   Sanierungsertrag (Ertrag, GuV)                                          22.000.000 EUR
```

### B. DES-Sacheinlage (Buchung — vereinfacht)

```
Per: Stammkapital (Kapitalerhoehung gegen Sacheinlage)                          50.000 EUR
Per: Kapitalruecklage                                                          5.150.000 EUR
Per: Sanierungsertrag (DES-Anteil ueber Werthaltigkeit, GuV)                  2.800.000 EUR
An:  Bankforderungen NordKurland-Konsortium                                    8.000.000 EUR
```
...
|---|---|---|
| Sanierungsertrag konsolidiert | 24.800.000 | 24.800.000 |
...
| Position | Wert (EUR) |
|---|---|
| Sanierungsertrag (Forderungsverzicht, ohne DES) | 22.000.000 |
| KSt-Verlustvortrag | 6.000.000 |
| GewSt-Verlustvortrag | 9.000.000 |
