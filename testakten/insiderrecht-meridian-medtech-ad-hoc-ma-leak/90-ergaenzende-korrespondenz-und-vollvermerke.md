# Ergänzende IR-, Vorstands- und BaFin-Korrespondenz

## Vollständige Gesprächsnotiz

Am 04.06.2026 schilderte Dr. Almut Seewald, Leiterin Legal & Compliance der Meridian MedTech SE die Angelegenheit in einem längeren Telefonat. Gegenstand ist Pressegerücht über den Verkauf der US-Tochter, Kursausschlag im Nachmittagshandel und unsauber geführte Projektinsiderliste während einer laufenden M&A-Verhandlung. Die Darstellung war nicht linear: Zunächst standen praktische Fristen und die Sorge vor Eskalation im Vordergrund, danach erst die rechtliche Einordnung. Für die weitere Bearbeitung ist deshalb wichtig, die Akte nicht nur nach Rechtsgebieten, sondern nach Entscheidungsdruck zu ordnen: Was muss sofort gesichert werden, was darf noch offen bleiben, und welche Erklärung kann später als Einlassung, Geständnis, Anerkenntnis oder zumindest als ungünstige Tatsachenbehauptung gelesen werden.

Die Projektbezeichnung “Orion” wurde am Vorabend in einem Kalendertermin mit externen Beratern nicht maskiert. Zwei Analysten riefen innerhalb von 25 Minuten an; parallel kaufte ein Mitarbeiter aus dem Finance-Team 380 Aktien über sein privates Depot. Der Aufschubvermerk ist begonnen, aber noch nicht vom Gesamtvorstand freigegeben. Nach Durchsicht der bisherigen Unterlagen fällt auf, dass mehrere Beteiligte dieselben Worte unterschiedlich verwenden. “Freigabe”, “Kenntnis”, “Sicherung”, “Rüge” und “Abstimmung” tauchen in E-Mails, Tabellen und Gesprächsnotizen auf, ohne dass klar ist, ob damit eine rechtliche Erklärung, eine interne Arbeitsanweisung oder nur eine vorläufige Arbeitshypothese gemeint ist. Für die weitere Bearbeitung genügt deshalb kein bloßer Ergebnisvermerk. Erforderlich ist ein nachvollziehbarer Ablauf mit Tonfall, Unsicherheiten und Belegstellen, damit spätere Schreiben, Gespräche und Anträge auf derselben Tatsachengrundlage stehen.

## E-Mail der Investor-Relations-Leitung an Vorstand und Legal

```
Von:      ir@meridian-medtech.test
An:       legal@meridian-medtech.test
Datum:    Do 04.06.2026, 08:47 Uhr
Betreff:  Gerücht HealthcareWire 14:07 Uhr - bitte Entscheidung Ad-hoc/Aufschub heute
```
...
Bitte keine weiteren Hintergrundgespräche mit Analysten führen, Insiderliste sofort nachziehen und die Entscheidung über Aufschub oder Veröffentlichung protokollfest bis 17:30 Uhr treffen. Bitte geben Sie mir bis morgen 12:00 Uhr eine Fassung, die ich intern weiterleiten kann. Sie darf gern klar sein, aber sie soll nicht dramatisieren. Wir brauchen eine Sprache, die die Sache ernst nimmt und trotzdem handhabbar bleibt.

Viele Grüße

Dr. Almut Seewald, Leiterin Legal & Compliance der Meridian MedTech SE
...
## Entwurf einer BaFin-Vorabnotiz und internen Trading-Sperre
