# 10 — Freie Quellen: dejure.org und openjur.de — URL-Pflicht

**Pruefkorpus-Abschnitt: Freie Online-Quellen**
...
## B. dejure.org — Format und Besonderheiten

dejure.org ist ein nicht-kommerzielles Rechtsportal, das BGH-, BVerfG- und viele Instanz-Entscheidungen kostenfrei bereitstellt. Die URLs sind stabil und folgen einem klaren Schema.
...
### Fundstelle 91 — dejure-URL fehlt (PV-URL)
...
### Fundstelle 92 — dejure Literatur-Verweis (Nachweis)

**Situation:** dejure.org listet die Zeitschriften-Fundstelle, bietet aber keinen Volltext.
...
**Kanzleistandard:** Archivlink empfohlen, da openjur.de ein privates Projekt ist (stabilitaetsrisiko).

### Fundstelle 93 — openjur korrekt
...
### Fundstelle 94 — openjur-URL fehlt (PV-URL)
...
### Fundstelle 95 — openjur ohne Archivlink (Kategorie C)
...
| 92 | dejure Literatur-Nachweis | kein | keiner |
| 93 | openjur + Archiv | kein | keiner |
| 94 | openjur | URL fehlt | PV-URL |
| 95 | openjur | Archiv fehlt (Empfehlung) | Kategorie C |

---

*Pruefkorpus-Abschnitt Freie Quellen: Fundstellen 90–95. Stand: Oktober 2025.*
