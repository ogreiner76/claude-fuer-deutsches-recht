# 12 — Mehrfach-Fundstellen: Rangfolge und Beispiele

**Kanzleihandbuch Zitierweise v4.0 — Rangfolge-Regelung**
**Stand: Oktober 2025**
...
2. Erste juristische    (NJW, JZ, AcP, MDR)
   Fachzeitschrift
3. Spezialisierte       (NZA, FamRZ, NVwZ, GRUR, BStBl.)
   Zeitschrift
4. Freie Online-Quelle  (dejure.org, openjur.de — mit URL)
5. BeckRS               (nur mit Lizenzzugang — sonst PV-BR)
```

Amtliche Online-Server (bundesgerichtshof.de etc.) ersetzen nicht die amtliche Sammlung in der Rangfolge, sondern erganzen als URL-Quelle.
...
### Fundstelle 97 — Rangfolge-Fehler NJW vor BGHZ (PV-RG)
...
### Fundstelle 98 — BeckRS an erster Stelle (doppelter Fehler: PV-RG + PV-BR)
...
### Fundstelle 99 — Korrekte Rangfolge BFH

**Entscheidung:** BFH, Urt. v. 23.01.2023, Az. IX R 8/22
**Quellen:** BFHE 278, 100 | BStBl. II 2023, 456
...
## C. Rangfolge-Tabelle nach Gerichtsbarkeit

### Zivilrecht / BGH

| Rang | Quelle |
|---|---|
| 1 | BGHZ (Zivilsachen) / BGHSt (Strafsachen) |
| 2 | NJW / JZ / AcP |
| 3 | MDR / ZIP / WM / GRUR |
| 4 | bundesgerichtshof.de (URL) |
| 5 | dejure.org (URL) |
| 6 | BeckRS (nur mit Lizenz) |
...
| 2 | NJW / JZ |
| 3 | NVwZ / DoeV |
| 4 | bundesverfassungsgericht.de (URL) |
| 5 | dejure.org (URL) |
| 6 | BeckRS (nur mit Lizenz) |
...
|---|---|
| 1 | BFHE |
| 2 | BStBl. II (bei Grundsatzentscheidungen) |
| 3 | DStR / DStRE / FR |
| 4 | bundesfinanzhof.de (URL) |
| 5 | BeckRS (nur mit Lizenz) |

### Verwaltungsrecht / BVerwG
...
*Pruefkorpus-Abschnitt Mehrfach-Fundstellen: Fundstellen 96–100 (Abschluss des 100-Fundstellen-Pruefkorpus). Stand: Oktober 2025.*
