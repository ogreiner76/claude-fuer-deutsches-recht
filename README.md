...
|---|---|
| **Plugins** | 212 |
| **Skills (SKILL.md)** | 18549 — [Gesamtübersicht](./SKILLS.md) |
| **Testakten** | 203 |
| **Fachanwalts-/-anwältinnen-Profile** | 24 |
| **Plugin-Version / Arbeitsstand** | `v242.0.0` — [latest Release auf GitHub](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest) |
