...
## Überblick v4.0.0 auf einen Blick
...
| **Letzter Release** | [v4.0.0](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/tag/v4.0.0) |
...
Alternativ: über die Claude-Desktop-GUI unter **Customize → Skills** → ZIP aus dem [Release v4.0.0](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/tag/v4.0.0) hochladen. Schritt-für-Schritt unter [Schnellstart](#schnellstart) und [Für Einsteiger](#für-einsteiger-schritt-für-schritt-anleitung).
