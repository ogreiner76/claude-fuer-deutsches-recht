...
|---|---|
| **Plugins** | 132 |
| **Skills (SKILL.md)** | 9487 — [Gesamtübersicht](./SKILLS.md) |
| **Testakten** | 140 |
| **Fachanwalts-/-anwältinnen-Profile** | 24 |
| **Plugin-Version / Arbeitsstand** | `v61.1.0` — [latest Release auf GitHub](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest) |
