...
description: "Verfolgt, wie sich ein Vertrag über Basisvertrag und alle Nachträge hinweg verändert hat – entweder als Gesamtüberblick aller Änderungen oder als Klausel-Rückverfolgung für eine bestimmte Bestimmung. Laden, wenn der Nutzer fragt \"was hat sich in diesem Vertrag geändert\", \"zeig mir die Nachtragshistorie\", \"wo steht die aktuelle [Klausel]\" oder mehrere Vertragsversionen hochlädt: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output."
---
