...
| `datenpunkt-dokument-excel-beweislast` | Datenpunkt: Dokumentenmatrix, Lückenliste und Nachforderung im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges P... |
...
| `gestapelt-immobilien-massenpruefung` | Gestapelt: Compliance-Dokumentation und Aktenvermerk im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges Prüffeld... |
...
| `mehrblatt-sonderfall-onboarding-perspektiven` | Mehrblatt: Sonderfall und Edge-Case-Prüfung im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges Prüffeld mit Norm... |
...
| `professional-review-tabellenreview-vendor-red` | Professional Review Sheet mit Rollen-, Daten- und Dokumentenperspektive: führt schnell durch Sachverhalt, Rechtsgrundlagen, Belege, Risiken und erzeugt einen verwertbaren nächsten Output: eigenständiges Prüffeld mit Norm-/Quellencheck, R... |
...
| `spezial-arbeitsblatt-schriftsatz-brief-und-memo-bausteine` | Arbeitsblatt: Schriftsatz-, Brief- und Memo-Bausteine im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges Prüffel... |
| `spezial-dokument-behoerden-gericht-und-registerweg` | Dokument: Behörden-, Gerichts- oder Registerweg im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges Prüffeld mit... |
| `spezial-excel-beweislast-und-darlegungslast` | Excel: Beweislast, Darlegungslast und Substantiierung im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges Prüffel... |
| `spezial-immobilien-formular-portal-und-einreichung` | Immobilien: Formular, Portal und Einreichungslogik im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges Prüffeld m... |
| `spezial-massenpruefung-mehrparteien-konflikt-und-interessen` | Massenpruefung: Mehrparteienkonflikt und Interessenmatrix im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges Prü... |
| `spezial-onboarding-mandantenkommunikation-entscheidungsvorlage` | Onboarding: Mandantenkommunikation und Entscheidungsvorlage im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges P... |
| `spezial-perspektiven-verhandlung-vergleich-und-eskalation` | Perspektiven: Verhandlung, Vergleich und Eskalation im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges Prüffeld... |
| `spezial-spaltenprompts-fristen-form-und-zustaendigkeit` | Spaltenprompts: Fristen, Form, Zuständigkeit und Rechtsweg im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges Pr... |
| `spezial-tabellenreview-erstpruefung-und-mandatsziel` | Tabellenreview: Erstprüfung, Rollenklärung und Mandatsziel im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges Pr... |
| `spezial-vendor-red-team-und-qualitaetskontrolle` | Vendor: Red-Team und Qualitätskontrolle im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges Prüffeld mit Norm-/Qu... |
| `spezial-wuerfel-tatbestand-beweis-und-belege` | Wuerfel: Tatbestandsmerkmale, Beweisfragen und Beleglage im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges Prüf... |
| `spezial-zeilenprompts-risikoampel-und-gegenargumente` | Zeilenprompts: Risikoampel, Gegenargumente und Verteidigungslinien im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenstän... |
...
| `tabellenreview-3d-mandantenkommunikation-redteam-qualitygate` | Mandantenkommunikation: übersetzt das Ergebnis in eine klare Nachricht mit Entscheidungspunkten, Risiken und nächsten Schritten: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `tabellenreview-3d-start-chronologie-fristen` | Einstieg, Schnelltriage und Fallrouting im Tabellenreview 3d-Plugin. Fragt Rolle, Ziel, Fristen, Unterlagen, Risiken und Wunsch-Output ab, schlägt passende Fachmodule aus diesem Plugin vor und führt in einen klaren Arbeitsplan. Bei Dokum... |
| `tabellenreview-3d-tr3d-bestreitensgruende-leitfaden` | Leitfaden Bestreitensgruende systematisch: dem Grunde, der Hoehe, dem Rang, Verjaehrung, Aufrechnung. Pruefraster fuer Tabellenpruefer: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `tr3d-feststellungsklage-tabellenfeststellung-spezial` | Spezialfall Feststellungsklage zur Tabellenfeststellung § 180 InsO: Klagebefugnis, Frist, Streitwert. Pruefraster fuer Glaeubiger und Insolvenzverwalter: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
...
| `tr3d-pruefkategorien-vorlage-vendor-wuerfel` | Bauleiter Pruefkategorien fuer Insolvenztabellenreview: Forderungsgrund, Bewertung, Bestreitenshistorie, Verteilungsquote. Pruefraster fuer drei-dimensionalen Aufbau: eigenständiges Prüffeld mit Norm-/Quellencheck, Risikoampel und verwer... |
...
| `vertragsstapel-vorlage-arbeitsvertrag` | Vertragsstapel: Internationaler Bezug und Schnittstellen im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges Prüf... |
...
| `wirtschaft-wuerfel-zeilenprompts` | Wirtschaft: Zahlen, Schwellenwerte und Berechnung im Plugin tabellenreview 3d; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung: eigenständiges Prüffeld mi... |
