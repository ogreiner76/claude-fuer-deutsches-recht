...
| Skill | Beschreibung |
| --- | --- |
| `bewertungen-red-team-impressumspflicht` | Bewertungen Behörden Gericht Und Registerweg, Chronologie Red Team Und Qualitaetskontrolle, Impressumspflicht Dokumentenmatrix Und Lueckenliste: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und li... |
| `eu-produktsicherheitsverordnung-feature` | Eu Produktsicherheitsverordnung Gpsr, Feature Risikobewertung, Impressum Pflicht: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `ist-ki-act-marktueberwachung-kommunikation` | Ist Das Ein Problem, Ki Act Produktintegration, Marktueberwachung Kommunikation: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `launch-livecheck-machinery` | Launch Tatbestand Beweis Und Belege, Livecheck Formular Portal Und Einreichung, Machinery Compliance Dokumentation Und Akte: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten b... |
...
| `nachhaltigkeitsklage-werbeaussagen` | Nachhaltigkeitsklage Werbeaussagen, Preisangaben, Prodr Gpsr Cra Fitness Spezial: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `pangv-prodr-produktbeobachtung` | Pangv Risikoampel Und Gegenargumente, Prodr Zahlen Schwellen Und Berechnung, Produktbeobachtung Verhandlung Vergleich Und Eskalation: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den n... |
| `prodr-machinery-produktrueckruf` | Prodr Machinery Regulation Spezial, Prodr Produktrueckruf Leitfaden, Produktbeobachtung Feldueberwachung: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `produktbeobachtung-software-produktrecht` | Produktbeobachtung Software Ota, Produktrecht Anpassen, Produktrecht Mandat Arbeitsbereich: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `produkthaftung-grundlagen-produktsicherheit` | Produkthaftung Grundlagen, Produkthaftung Produktsicherheit Gpsr Korrektur, Produkthaftung Reparatur Update Und Lifecycle: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten bel... |
| `produktlaunch-beweislast-rechtscheck` | Produktlaunch Beweislast Und Darlegungslast, Produktlaunch Rechtscheck, Produktnutzung Und Claimcheck: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `produktrecht-anschluss-router` | Allgemein, Anschluss Skills Router, Chronologie Und Belegmatrix, ...: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `produktrecht-fristen-risikoampel-mandantenkommunikation` | Fristen Und Risikoampel, Mandantenkommunikation, Redteam Qualitygate: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `produktrecht-produktrechtliche-rechtscheck` | Produktrecht Schriftsatz Brief Und Memo Bausteine, Produktrechtliche Erstpruefung Und Mandatsziel, Rechtscheck Sonderfall Und Edge Case: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert de... |
...
| `rechtsabteilung-cybersecurity-digitale` | Rechtsabteilung Cybersecurity Als Produktsicherheitsmerkmal, Rechtsabteilung Digitale Elemente Im Kaufrecht, Rechtsabteilung Right To Repair Im Geraetevertrieb: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechts... |
| `rechtsabteilung-produkthaftungsrichtlinie-ce` | Rechtsabteilung Neue Produkthaftungsrichtlinie Und Softwareprodu, Ce Kennzeichnung Routenplan, Dual Use Produktrecht: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastba... |
| `rechtsabteilung-rueckrufmanagement-repair-by` | Rechtsabteilung Rueckrufmanagement Mit Rapex Safety Gate, Repair By Design Software Locks Ersatzteile, Reparaturpflicht Hersteller Nach Gewaehrleistung: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlag... |
| `regulation-interessen-werbeaussagen` | Regulation Mehrparteien Konflikt Und Interessen, Werbeaussagen Prüfung: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `review-prodr-produkthaftung-digital` | Review Fristen Form Und Zustaendigkeit, Prodr Produkthaftung Bauleiter, Produkthaftung Digital Software Pld 2024 2853: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastb... |
| `right-to-rueckruf-strategie` | Right To Repair Produktrecht 2024 1799, Rueckruf Strategie Konzern, Belegmatrix Mandantenkommunikation Entscheidungsvorlage: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten b... |
