...
| `datenschutzrecht-anschluss` | Anschluss im Datenschutzrecht: prüft konkret Einstieg, Schnelltriage und Fallrouting im Datenschutzrecht-Plugin, Anschluss-Skills Router im Plugin datenschutzrecht, Chronologie und Belegmatrix im Plugin datenschutzrecht. Liefert priorisi... |
...
| `datenschutzrecht-auskunft-behoerden-gerichts-registerweg` | Auskunft: Behörden-, Gerichts- oder Registerweg im Datenschutzrecht: 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellung, Schwelle, Zah... |
| `datenschutzrecht-bdsg-tatbestandsmerkmale-beweisfragen-beleglage` | Bdsg: Tatbestandsmerkmale, Beweisfragen und Beleglage im Datenschutzrecht: 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellung, Schwell... |
| `datenschutzrecht-behoerdenpaket-zahlen-schwellenwerte-berechnung` | Behoerdenpaket: Zahlen, Schwellenwerte und Berechnung im Datenschutzrecht: 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellung, Schwell... |
| `datenschutzrecht-chronologie-und-belegmatrix` | Chronologie und Belegmatrix im Datenschutzrecht: 1. Wer fragt in welcher Rolle? 2. Was ist das gewünschte Ergebnis? 3. Gibt es Fristen, Termine, Zustellungen, Zahlungen oder Sanktionen? 4. Welche Unterlagen, Daten oder Belege liegen bere... |
| `datenschutzrecht-datenpanne-schriftsatz-brief-memo-bausteine` | Datenpanne: Schriftsatz-, Brief- und Memo-Bausteine im Datenschutzrecht: 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellung, Schwelle,... |
...
| `datenschutzrecht-dpia-dokumentenmatrix-lueckenliste` | Dpia: Dokumentenmatrix, Lückenliste und Nachforderung im Datenschutzrecht: 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellung, Schwell... |
| `datenschutzrecht-drittlandstransfer-tia-scc` | Drittlandstransfer: Verhandlung, Vergleich und Eskalation im Datenschutzrecht: 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellung, Sch... |
| `datenschutzrecht-dsgvo-erstpruefung-rollenklaerung-mandatsziel` | DSGVO: Erstprüfung, Rollenklärung und Mandatsziel im Datenschutzrecht: 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellung, Schwelle, Z... |
| `datenschutzrecht-dsgvo-intake-basispruefung` | Datenschutzrecht: Compliance-Dokumentation und Aktenvermerk im Datenschutzrecht: 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellung, S... |
...
| `datenschutzrecht-fristen-und-risikoampel` | Fristen- und Risikoampel im Datenschutzrecht: 1. Wer fragt in welcher Rolle? 2. Was ist das gewünschte Ergebnis? 3. Gibt es Fristen, Termine, Zustellungen, Zahlungen oder Sanktionen? 4. Welche Unterlagen, Daten oder Belege liegen bereits... |
...
| `datenschutzrecht-mandantenkommunikation` | Mandantenkommunikation im Datenschutzrecht: 1. Wer fragt in welcher Rolle? 2. Was ist das gewünschte Ergebnis? 3. Gibt es Fristen, Termine, Zustellungen, Zahlungen oder Sanktionen? 4. Welche Unterlagen, Daten oder Belege liegen bereits vor? |
...
| `datenschutzrecht-output-waehlen` | Output wählen im Datenschutzrecht: Diese Output-Weiche für Datenschutzrecht entscheidet, ob Memo, Antrag, Schriftsatz, Tabelle, Risikoampel, Fragenliste oder Mandantenbrief der richtige nächste Schritt ist. |
| `datenschutzrecht-paket-internationaler-bezug-schnittstellen` | Paket: Internationaler Bezug und Schnittstellen im Datenschutzrecht: 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellung, Schwelle, Zah... |
...
| `datenschutzrecht-review-risikoampel-gegenargumente` | Review: Risikoampel, Gegenargumente und Verteidigungslinien im Datenschutzrecht: 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellung, S... |
| `datenschutzrecht-tdddg-fristen-form-zustaendigkeit-rechtsweg` | Tdddg: Fristen, Form, Zuständigkeit und Rechtsweg im Datenschutzrecht: 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellung, Schwelle, Z... |
...
| `datenschutzrecht-verarbeitungsverzeichnis-art30` | Verarbeitungsverzeichnis: Formular, Portal und Einreichungslogik im Datenschutzrecht: 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellu... |
