...
| `input-compliance-dokumentation` | Input: Compliance-Dokumentation und Aktenvermerk: 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellung, Schwelle, Zahlung, Sanktion oder... |
| `input-compliance-dokumentation-und-akte` | Input: Compliance-Dokumentation und Aktenvermerk. |
