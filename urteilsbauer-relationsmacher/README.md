...
| `amts-aktenintake-zivil-anspruchsgrundlagen` | Amts Aktenintake Zivil Anspruchsgrundlagen im Plugin Urteilsbauer Relationsmacher: prüft konkret Amts, Eingehende Zivilakte vor erster Prüfung strukturieren, Anspruchsgrundlagen identifizieren und Prüfungsreihenfolge. Liefert priorisiert... |
...
| `berufungsfest-beschluss-bauen-beweisbeschluss` | Berufungsfest Beschluss Bauen Beweisbeschluss im Plugin Urteilsbauer Relationsmacher: prüft konkret Fertiges Urteil gegen häufigste Aufhebungsgründe selbst, Zivilrechtliche Beschluesse erstellen, Beweisbeschluss nach § 359 ZPO vorbereite... |
...
| `beweiswuerdigung-richter-cisg-dsgvo` | Beweiswuerdigung Richter CISG DSGVO im Plugin Urteilsbauer Relationsmacher: prüft konkret Strukturierte Beweiswürdigung nach § 286 ZPO schreiben, UN-Kaufrecht (CISG) auf Anwendbarkeit und Eingreifen prüfen, Produkt aus dem Ausland auf DS... |
...
| `entscheidungsgruende-redaktion` | Entscheidungsgruende Redaktion im Plugin Urteilsbauer Relationsmacher: prüft konkret Entscheidungsgründe redaktionell, beweisfest und berufungsfest bauen, Familienrichter, Input. Liefert priorisierten Output mit Norm-Pinpoints, Risikoamp... |
...
| `entscheidungsgruende-zivil-familienrichter` | Entscheidungsgruende Zivil Familienrichter im Plugin Urteilsbauer Relationsmacher: prüft konkret Entscheidungsgründe eines Zivilurteils im Urteilsstil, FamFG-Spezifika für Familienrichter anwenden, Incoterms-Klausel und Gefahruebergang i... |
...
| `internationales-privatrecht-kollidierende-agb` | Internationales Privatrecht Kollidierende AGB im Plugin Urteilsbauer Relationsmacher: prüft konkret Anwendbares Recht bei grenzüberschreitenden Vertraegen und, Kollidierende AGB im B2B-Verkehr (Battle of the Forms) lösen, Kostenentscheid... |
...
| `land-rechtspfleger-relation` | Land Rechtspfleger Relation im Plugin Urteilsbauer Relationsmacher: prüft konkret Land, Rechtspfleger, Relation. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `rechtsmittelbelehrung-zivil-relation` | Rechtsmittelbelehrung Zivil Relation im Plugin Urteilsbauer Relationsmacher: prüft konkret Prüffeld für rechtsmittelbelehrung zivil, Zivilrechtliche Relation nach klassischer Relationstechnik, Prüfung gegen Aufhebung in der Revision. Lie... |
...
| `richter-richterlicher-hinweis` | Richter Richterlicher Hinweis im Plugin Urteilsbauer Relationsmacher: prüft konkret Richter, Richterlicher Hinweis, Aufklärung und Parteivortrag in die Relation einbauen, Tatbestand. Liefert priorisierten Output mit Norm-Pinpoints, Risik... |
...
| `schulung-urteilsbauer-aktenintake-beschluss` | Schulung Urteilsbauer Aktenintake Beschluss im Plugin Urteilsbauer Relationsmacher: prüft konkret Schulungs-Trainerleitfaden für Plugin, Aktenintake, Beschluss. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Sc... |
...
| `tatbestandsmerkmale-interessen-tenor-urteils` | Tatbestandsmerkmale Interessen Tenor Urteils im Plugin Urteilsbauer Relationsmacher: prüft konkret Tatbestandsmerkmale, Tenor, Urteils. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `urb-relationstechnik-entscheidungsgruende` | URB Relationstechnik Entscheidungsgruende im Plugin Urteilsbauer Relationsmacher: prüft konkret Bauleiter Relationstechnik, Leitfaden Tatbestand und Entscheidungsgruende, Spezialfall Versaeumnisurteil und Einspruch §§ 330 ff. Liefert pri... |
...
| `urteilsbauer-relation-start-chronologie-fristen` | Relation Start Chronologie Fristen im Plugin Urteilsbauer Relationsmacher: prüft konkret Einstieg, Schnelltriage und Fallrouting im Urteilsbauer, Chronologie und Belegmatrix im Plugin, Fristen- und Risikoampel im Plugin. Liefert priorisi... |
...
| `vollrelation-langfassung-vorlaeufige` | Vollrelation Langfassung Vorlaeufige im Plugin Urteilsbauer Relationsmacher: prüft konkret Vollständige Relation im Schulstandard für, Anordnung zur vorlaeufigen Vollstreckbarkeit nach §§, Zulässigkeit der Zivilklage systematisch prüfen.... |
...
| `zivil-schreiben-tenor-bauen-urb-mehrere` | Zivil Schreiben Tenor Bauen URB Mehrere im Plugin Urteilsbauer Relationsmacher: prüft konkret Tatbestand eines Zivilurteils nach § 313 Abs, Tenor eines Zivilurteils konstruieren, Spezialfall mehrere Streitgegenstaende und Eventualantraeg... |
