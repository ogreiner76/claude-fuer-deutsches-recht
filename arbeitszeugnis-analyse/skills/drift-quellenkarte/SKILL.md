...
description: "Nutze dies zur Quellenprüfung bei Drift Quellenkarte: Normenstand, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor einer tragenden Aussage verifiziert."
---
...
Nutze diese Quellenkarte, wenn im Bereich **Arbeitszeugnis Analyse** tragende Normen, Rechtsprechung, Behördenpraxis, Register, Formulare oder aktuelle Leitlinien geprüft werden müssen.

## Suchraster

- `ampelsystem-tabellenausgabe`
- `aufforderungsschreiben-arbeitgeber`
- `azubi-zeugnis-analyse`
- `bereichs-drift-detektor`
- `branchen-spezifische-formulierungen`
- `erstgespraech-und-mandatsannahme`
- `geheimcode-katalog`
- `gesamtnoten-aggregation`
- `gruen-flaggen-katalog`
- `klage-strategie-zeugnisberichtigung`
