...
| `arbeitszeugnis-analyse-chronologie-und-belegmatrix` | Chronologie und Belegmatrix im Plugin Arbeitszeugnis Analyse: prüft Tatbestand, Zuständigkeit, Frist und Beweislage entlang der Plugin-Norm-Anker und liefert priorisierten Output (Norm-Pinpoints, Risikoampel, nächster Schritt). |
...
| `arbeitszeugnis-analyse-fristen-und-risikoampel` | Fristen- und Risikoampel im Plugin Arbeitszeugnis Analyse: prüft Tatbestand, Zuständigkeit, Frist und Beweislage entlang der Plugin-Norm-Anker und liefert priorisierten Output (Norm-Pinpoints, Risikoampel, nächster Schritt). |
